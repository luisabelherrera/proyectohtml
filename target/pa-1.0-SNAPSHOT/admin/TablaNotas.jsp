<%-- 
    Document   : TablaNotas
    Created on : 2/04/2024, 12:40:46 a. m.
    Author     : abel
--%>
        ...
        <section id="container" >
                ...
                <div id="sidebar"  class="nav-collapse">
                    <ul class="sidebar-menu nav">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul>
                                <li><a href="../admin/TablaAlumno.jsp"  class="abc">Registrar Nuevo Alumno</a> <br></li>
                                <li><a href="../admin/TablaAlumno.jsp" class="abc">Modificar Alumno</a></li>
                                <li><a href="../admin/TablaAlumno.jsp" class="abc">Listado Alumnos</a></li>
                                <li><a href="../admin/TablaAlumno.jsp" class="abc">Eliminar Alumnos</a></li>
            ...
            <section id="main-content">
                ...
                <div id="main">
                    ...
                    <br>
                    <br>
                    <span class="text1">GESTIONAR NOTAS</span>
                    ...
                    <select id="filtroSelect">
                        <option value="ID_Alumno">ID alumno</option>
                    </select>
                    <input type="text" id="filtroInput" onkeyup="filtrarTabla()" />
                    <br>
                    <br>
                    <table id="tablaNotas" class="table table-bordered border-primary">
                        <thead>
                            <tr class="table-dark">
                                <th>ID Nota</th>
                                <th>ID Alumno</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="mostrarDetallesBtn" data-id-nota="#1" data-id-alumno="1001" data-id-curso="101" data-calificacion="90" data-fecha-calificacion="2024-03-01">Mostrar Detalles</button>
                                    <div id="detalle_nota_1" style="display: none;"> 
                                        <p>Otros detalles...</p>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>Otros atributos...</td>
                                <td>
                                    <button class="mostrarDetallesBtn" data-id-nota="#2" data-id-alumno="1002" data-id-curso="102" data-calificacion="85" data-fecha-calificacion="2024-03-02">Mostrar Detalles</button>
                                    <div id="detalle_nota_2" style="display: none;"> 
                                        <p>Otros detalles...</p>
                                    </div>
                                </td>
                            </tr>
