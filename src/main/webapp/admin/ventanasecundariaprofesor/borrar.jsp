<%-- 
    Document   : borrar
    Created on : 2/04/2024, 12:45:13 a. m.
    Author     : abel
--%>
        ...
        <section id="container" >
            ...
            <section id="main-content">
                ...
                <div id="main">
                    ...
                    <form id="formularioBorrarProfesor">
                        <label for="idProfesorBorrar">ID Profesor a Borrar:</label>
                        <input type="text" id="idProfesorBorrar" required>

                        <br>
                        <br>
                        <button type="button" onclick="borrarProfesor()">Borrar</button>
                        <br>
                        <br>
                        <button type="button" onclick="confirmarBorrado()">Confirmar Borrado</button>
                    </form>
