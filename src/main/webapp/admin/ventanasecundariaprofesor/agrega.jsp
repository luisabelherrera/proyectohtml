<%-- 
    Document   : agrega
    Created on : 2/04/2024, 12:45:52 a. m.
    Author     : abel
--%>
            ...
            <section id="main-content">
                ...
                <div id="main">
                    ...
                    <form id="formularioProfesor">
                        ...
                        <input type="text" id="idProfesor" required>
                        ...
                        <br>
                        <br>
                        <button type="button" onclick="guardarProfesor()">Guardar</button>
                        <button type="button" onclick="mostrarDetalles()">Mostrar Detalles</button>
                    </form>
