<%-- 
    Document   : modificar
    Created on : 2/04/2024, 12:46:47 a. m.
    Author     : abel
--%>
            ...
            <section id="main-content">
                ...
                <div id="main">
                    ...
                    <form id="formularioModificarAlumno">
                        <div class="campo">
                            <label for="idAlumnoModificar">ID Alumno:</label>
                            <input type="text" id="idAlumnoModificar" required>
                        </div>
                        ...
                        <div class="campo">
                            ...
                            <input type="text" id="nuevoGrado" required>
                        </div>

                        <div class="campo">
                            <label for="nuevaSeccion">Nueva Sección:</label>
                            <input type="text" id="nuevaSeccion" required>
                        </div>

                        <div class="campo">
                            <label for="nuevaFechaInscripcion">Nueva Fecha de inscripción:</label>
                            <input type="date" id="nuevaFechaInscripcion" required>
                        </div>

                        <div class="campo">
                            <label for="nuevaMateria">Nueva Materia:</label>
                            <input type="text" id="nuevaMateria" required>
                        </div>

                        <div class="campo">
                            <label for="nuevoNivel">Nuevo Nivel:</label>
                            <input type="text" id="nuevoNivel" required>
                        </div>
