<%-- 
    Document   : borrar
    Created on : 2/04/2024, 12:47:14 a. m.
    Author     : abel
--%>
        ...
        <section id="container" >
            ...
            <section id="main-content">
                ...
                <div id="main">
                    ...
                    <form id="formularioBorrarAlumno">
                        <div class="campo">
                            <label for="idAlumnoBorrar">ID Alumno a Borrar:</label>
                            <input type="text" id="idAlumnoBorrar" required>
                        </div>

                        <div class="botones">
                            <button type="button" onclick="borrarAlumno()">Borrar</button>
